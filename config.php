...
define("SITE_NAME", "AppSuratMasukKeluar");
...
define("APP_ID", "8d6adf820fd0a4a4796f90959c80814e");
...
define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['Id_Pengguna'] : null ));
define('USER_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['Nama_Pengguna'] : null ));
define('USER_EMAIL',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['id_Nomor'] : null ));
